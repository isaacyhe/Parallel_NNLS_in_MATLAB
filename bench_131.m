% Benchmark on 131x131 Tikhonov problem (17161 columns)
% Compare lsqnonneg vs Classic AS OMP FP64/FP32 (incremental Cholesky)

diary('/tmp/bench_131.log');
diary on;
...
fprintf('Classic AS FP64 OMP (inc Chol) ... '); tic;
...
fprintf('Classic AS FP32 OMP (inc Chol) ... '); tic;
